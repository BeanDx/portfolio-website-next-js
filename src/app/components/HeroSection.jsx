      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg lg:text-xl mb-6">
            ...
            beatae nihil est, error earum odit, alias sint culpa, fugit ratione
            eius delectus numquam repellat veritatis commodi deserunt aperiam
            maiores cumque.
          </p>
          <div>
            <button
            ...
            >
              <span
                className="block bg-[#121212] hover:bg-slate-800 
        ...
        <div className="col-span-5 place-self-center mt-4 lg:mt-0">
          ...
          >
            <Image
              ...
              height={300}
              onClick={() => {
                alert("This image generated by AI :D");
              }}
            />
          </div>
        </div>
